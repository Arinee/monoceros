...
/// Author: yijun <yijun@xiaohongshu.com>
/// Created: 2019-09-24 14:17
...
class IndexBuilderIvfpqTest: public testing::Test {
public:
    void SetUp() {}
    void TearDown() {}
};

TEST_F(IndexBuilderIvfpqTest, TestNormalUse) {
    SchemaParams schema = {
        {"DataType", "float"},
        {"Method", "L2"}, {"Dimension", "256"}, {"IndexType", "IvfPQ"},
        {"TrainDataPath", "tests/engine/redindex/test_data/coarse_8191"},
        {"IvfCoarseScanRatio", "0.05"},
        {"IvfPQScanNum", "2000"},
        {"PqCentroidNum", "256"},
        {"PqFragmentCnt", "32"}
    };
    ...
    mercury::core::IvfPqIndex* core_index = dynamic_cast<mercury::core::IvfPqIndex*>(loaded_index.core_index_.get());
