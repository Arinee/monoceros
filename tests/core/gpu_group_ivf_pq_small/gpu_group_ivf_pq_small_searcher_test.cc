...
#include "src/core/algorithm/group_ivf_pq_small/group_ivf_pq_small_merger.h"
...
class GpuGroupIvfPqSmallSearcherTest : public testing::Test
{
public:
    void SetUp()
    {
        ...
        index_params_.set(PARAM_INDEX_TYPE, "GroupIvfPqSmall");
...
TEST_F(GpuGroupIvfPqSmallSearcherTest, TestSearch)
{
    Index::Pointer index1 = factory_.CreateIndex();
    mercury::core::GroupIvfPqSmallIndex *core_index1 = dynamic_cast<mercury::core::GroupIvfPqSmallIndex *>(index1.get());
    ...
    mercury::core::GroupIvfPqSmallIndex *core_index2 = dynamic_cast<mercury::core::GroupIvfPqSmallIndex *>(index2.get());
    ...
    GroupIvfPqSmallMerger *ivf_pq_merger = dynamic_cast<GroupIvfPqSmallMerger *>(index_merger.get());
    mercury::core::GroupIvfPqSmallIndex &merged_index = ivf_pq_merger->merged_index_;
