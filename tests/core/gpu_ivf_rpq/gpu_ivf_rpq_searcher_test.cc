...
class GpuIvfRpqSearcherTest : public testing::Test
{
public:
    void SetUp()
    {
...
TEST_F(GpuIvfRpqSearcherTest, TestRpqRawLvl1)
{
    ...
    LOG_INFO("gpu ivf rpq search success");
}

TEST_F(GpuIvfRpqSearcherTest, TestRpqRawLvl2)
{
