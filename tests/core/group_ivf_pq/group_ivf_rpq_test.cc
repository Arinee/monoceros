...
class GroupIvfRPQTest: public testing::Test
{
public:
    void SetUp()
        {
...
TEST_F(GroupIvfRPQTest, TestMultiGroupError) {
...
TEST_F(GroupIvfRPQTest, TestRpqRefineLvl1) {
    ...
    index_params_.set(PARAM_TRAIN_DATA_PATH, "tests/core/group_ivf_pq/test_data_residual");
    index_params_.set(PARAM_ENABLE_RESIDUAL, true);
    factory_.SetIndexParams(index_params_);
    Index::Pointer index = factory_.CreateIndex();
...
TEST_F(GroupIvfRPQTest, TestRpqRawLvl1) {
...
TEST_F(GroupIvfRPQTest, TestPqRawLvl1) {
    index_params_.set(PARAM_GENERAL_CONTAIN_FEATURE_PROFILE, false);
    index_params_.set(PARAM_DATA_TYPE, "float");
    index_params_.set(PARAM_DIMENSION, 64);
    index_params_.set(PARAM_TRAIN_DATA_PATH, "tests/core/group_ivf_pq/test_data_residual");
...
TEST_F(GroupIvfRPQTest, TestRpqRefineLvl2) {
    index_params_.set(PARAM_GENERAL_CONTAIN_FEATURE_PROFILE, true);
    index_params_.set(PARAM_DATA_TYPE, "half");
    index_params_.set(PARAM_ENABLE_FINE_CLUSTER, true);
    index_params_.set(PARAM_DIMENSION, 64);
    index_params_.set(PARAM_TRAIN_DATA_PATH, "tests/core/group_ivf_pq/test_data_two_stage_residual");
    index_params_.set(PARAM_ENABLE_RESIDUAL, true);
...
TEST_F(GroupIvfRPQTest, TestRpqRawLvl2) {
    index_params_.set(PARAM_GENERAL_CONTAIN_FEATURE_PROFILE, false);
    index_params_.set(PARAM_DATA_TYPE, "half");
    index_params_.set(PARAM_ENABLE_FINE_CLUSTER, true);
    index_params_.set(PARAM_DIMENSION, 64);
...
TEST_F(GroupIvfRPQTest, TestPqRawLvl2) {
    index_params_.set(PARAM_GENERAL_CONTAIN_FEATURE_PROFILE, false);
    index_params_.set(PARAM_DATA_TYPE, "half");
    index_params_.set(PARAM_ENABLE_FINE_CLUSTER, true);
    index_params_.set(PARAM_DIMENSION, 64);
