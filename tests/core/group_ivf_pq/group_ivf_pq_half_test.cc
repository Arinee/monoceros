...
class GroupIvfPqHalfTest: public testing::Test
{
public:
    void SetUp()
        {
...
TEST_F(GroupIvfPqHalfTest, TestGetRankScore) {
...
TEST_F(GroupIvfPqHalfTest, TestGetRankScoreBySpecifiedGroupLevel) {
...
TEST_F(GroupIvfPqHalfTest, TestSearch) {
    std::cout << "cwd is:" << getcwd(NULL, 0) << std::endl;
    ...
    query_info4.SetFeatureTypes(IndexMeta::FeatureTypes::kTypeHalfFloat);
    ...
    query_info5.SetFeatureTypes(IndexMeta::FeatureTypes::kTypeHalfFloat);
