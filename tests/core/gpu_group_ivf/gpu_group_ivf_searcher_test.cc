...
class GpuGroupIvfSearcherTest : public testing::Test
{
public:
    void SetUp()
    {
        ...
        index_params_.set(PARAM_VECTOR_INDEX_NAME, "GpuGroupIvfSearcherTest");
...
TEST_F(GpuGroupIvfSearcherTest, TestSearch)
{
