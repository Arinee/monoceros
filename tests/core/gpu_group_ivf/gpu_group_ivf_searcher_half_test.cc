...
class GpuGroupIvfSearcherHalfTest : public testing::Test
{
public:
    void SetUp()
    {
        ...
        index_params_.set(PARAM_VECTOR_INDEX_NAME, "GpuGroupIvfSearcherHalfTest");
...
TEST_F(GpuGroupIvfSearcherHalfTest, TestSearch)
{
