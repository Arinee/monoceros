...
class GpuGroupIvfSearcherMultiAgeTest : public testing::Test
{
public:
    void SetUp()
    {
        ...
        index_params_.set(PARAM_VECTOR_INDEX_NAME, "GpuGroupIvfSearcherMultiAgeTest");
...
TEST_F(GpuGroupIvfSearcherMultiAgeTest, TestSearch)
{
    ...
    ret = core_index1->Add(docid + 1, INVALID_PK, group_str, mock_note_id);
    ASSERT_EQ(0, ret);
    ...
    mock_note_id = hexStr;
    mock_note_id += "abcdefghigklmnop";
    ret = core_index2->Add(docid2, INVALID_PK, group_str, mock_note_id);
    ret = core_index2->Add(docid2 + 1, INVALID_PK, group_str, mock_note_id);
    ASSERT_EQ(0, ret);
    ...
    std::string search_str = "100&0:0#0||" + data_str + "||" + PARAM_MULTI_AGE_MODE + "=1800#10;7200#10";
