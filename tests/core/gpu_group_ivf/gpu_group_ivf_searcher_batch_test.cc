...
class GpuGroupIvfSearcherBatchTest : public testing::Test
{
public:
    void SetUp()
    {
        ...
        index_params_.set(PARAM_VECTOR_INDEX_NAME, "GpuGroupIvfSearcherBatchTest");
...
TEST_F(GpuGroupIvfSearcherBatchTest, TestSearch)
{
