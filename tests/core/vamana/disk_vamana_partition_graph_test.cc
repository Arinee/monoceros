...
class DiskVamanaPartitionGraphTest: public testing::Test
{
public:
    void SetUp()
    {
...
TEST_F(DiskVamanaPartitionGraphTest, BuildAndDump) {

    GTEST_SKIP() << "Skipping DiskVamanaPartitionGraphTest.BuildAndDump";
...
TEST_F(DiskVamanaPartitionGraphTest, LoadAndSearch) {

    GTEST_SKIP() << "Skipping DiskVamanaPartitionGraphTest.LoadAndSearch";

    // Set to false in order to avoid reset ori/raw data file in DiskVamanaIndex::Create method
