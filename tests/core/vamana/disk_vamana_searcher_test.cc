...
class DiskVamanaSearcherTest: public testing::Test
{
public:
    void SetUp()
    {
        ...
        index_params_.set(PARAM_VAMANA_INDEX_SEARCH_L, 120);
        index_params_.set(PARAM_VAMANA_INDEX_SEARCH_BW, 2);
...
TEST_F(DiskVamanaSearcherTest, TestSearchPartition) {
