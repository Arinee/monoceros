...
class DiskVamanaHalfSearcherTest: public testing::Test
{
public:
    void SetUp()
    {
...
TEST_F(DiskVamanaHalfSearcherTest, TestSearchPartition) {
    ...
    std::string disk_index_sift_learn_path = std::string(get_current_dir_name()) + "/vamana_partition_half_disk.index";

    std::string medoids_data_sift_learn_path = std::string(get_current_dir_name()) + "/vamana_partition_half_medoids.bin";
