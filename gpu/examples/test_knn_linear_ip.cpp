...
int main (int argc, char *argv[]) 
{
    ...
    proxima::gpu::Calculator *cal = new proxima::gpu::GPUFloatInnerProductCalculator();
    ...
    for (int i = 0; i < 1000; ++i) {
        ...
        linear_index.search((const void *)query_view.data(), (float *)outDistances.data(), outIndices.data(), qnum, topk);
