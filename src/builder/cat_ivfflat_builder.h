#ifndef MERCURY_CAT_IVFFLAT_BUILDER_H__
#define MERCURY_CAT_IVFFLAT_BUILDER_H__
...
class CatIvfFlatBuilder : public IndexBuilder
{
public:
    //! Constructor
    CatIvfFlatBuilder() : _globalId(0), _segment(0) {}

    //! Destructor
    ~CatIvfFlatBuilder() override;
...
#endif // MERCURY_CAT_IVFFLAT_BUILDER_H__
