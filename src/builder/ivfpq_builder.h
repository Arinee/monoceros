#ifndef MERCURY_IVFPQ_BUILDER_H_
#define MERCURY_IVFPQ_BUILDER_H_
...
class IvfpqBuilder : public IndexBuilder
{
public:
    //! Constructor
    IvfpqBuilder() :_globalId(0),
                    _segment(0),
                    _isTrainDone(true),
                    _isRuned(false)
    {}
...
#endif // MERCURY_IVFPQ_BUILDER_H_
