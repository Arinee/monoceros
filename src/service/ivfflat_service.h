...
#ifndef __MERCURY_IVFFLAT_SERVICE_H__
#define __MERCURY_IVFFLAT_SERVICE_H__
...
/*! Ivfflat Service
 */
class IvfflatService : public VectorService
{
public:
    //! constructor
    IvfflatService(void)
    ...
    //! Destructor
    virtual ~IvfflatService(void) override;
...
#endif // __MERCURY_IVFFLAT_SERVICE_H__
