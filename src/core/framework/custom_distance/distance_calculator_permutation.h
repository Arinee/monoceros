#ifndef __MERCURY_CORE_FRAMEWORK_DISTANCE_CALCULATOR_PERMUTATION_H__
#define __MERCURY_CORE_FRAMEWORK_DISTANCE_CALCULATOR_PERMUTATION_H__
...
class PermutationCalculator : public BaseCustomCalculator {
public:
    PermutationCalculator(size_t elemSize, size_t dimension, IndexDistance::Measure measure, uint32_t part_dimension)
...
#endif  // __MERCURY_CORE_FRAMEWORK_DISTANCE_CALCULATOR_PERMUTATION_H__