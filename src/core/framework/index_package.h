...
public:
    ...
    void*& getAligned32Seg() {
        return _aligned32seg;
    }

    size_t& getAligned32Size() {
        return _aligned32size;
    }

private:
    std::vector<IndexPackage::Segment> _vec;
    void* _aligned32seg = nullptr;
    size_t _aligned32size = 0;
    char* _dumpPtr = nullptr;
};
