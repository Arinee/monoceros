...
#ifndef __MERCURY_CORE_GPU_GROUP_IVF_PQ_SEARCHER_H__
#define __MERCURY_CORE_GPU_GROUP_IVF_PQ_SEARCHER_H__
...
#include "src/core/algorithm/group_ivf_pq/group_ivf_pq_index.h"
...
class GpuGroupIvfPqSearcher : public Searcher
{
public:
    typedef std::shared_ptr<GpuGroupIvfPqSearcher> Pointer;

public:
    GpuGroupIvfPqSearcher();
    ~GpuGroupIvfPqSearcher();
    //! Init from params
    ...
    metric metric_GpuGroupIvfPq_CentroidNum, metric_GpuGroupIvfPq_GroupNum, metric_GpuGroupIvfPq_FullDocNum,
        metric_GpuGroupIvfPq_RtDocNum;
...
private:
    ...
    int CollectIvfPostings(std::vector<CoarseIndex<BigBlock>::PostingIterator> &ivf_postings,
    ...
    void RecoverPostingFromSlot(std::vector<CoarseIndex<BigBlock>::PostingIterator> &postings,
