...
#ifndef __MERCURY_CORE_GPU_GROUP_IVF_PQ_SMALL_SEARCHER_H__
#define __MERCURY_CORE_GPU_GROUP_IVF_PQ_SMALL_SEARCHER_H__
...
class GpuGroupIvfPqSmallSearcher : public Searcher
{
public:
    typedef std::shared_ptr<GpuGroupIvfPqSmallSearcher> Pointer;

public:
    GpuGroupIvfPqSmallSearcher();
    ~GpuGroupIvfPqSmallSearcher();
    //! Init from params
...
#endif // __MERCURY_CORE_GPU_GROUP_IVF_PQ_SMALL_SEARCHER_H__
