#ifndef __MERCURY_CORE_GROUP_IVF_PQ_SMALL_BUILDER_H__
#define __MERCURY_CORE_GROUP_IVF_PQ_SMALL_BUILDER_H__
...
class GroupIvfPqSmallBuilder : public Builder
{
public:
    //! Index Builder Pointer
    typedef std::shared_ptr<GroupIvfPqSmallBuilder> Pointer;

    GroupIvfPqSmallBuilder() {}
...
#endif // __MERCURY_CORE_GROUP_IVF_PQ_SMALL_BUILDER_H__
