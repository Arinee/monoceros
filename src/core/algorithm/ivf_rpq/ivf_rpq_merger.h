...
/*! Index Merger
 */
class IvfRpqMerger : public Merger
{
public:
    //! Index Merger Pointer
    typedef std::shared_ptr<IvfRpqMerger> Pointer;
...
private:
    ...
    int GenerateSlotsProfile(const IvfRpqIndex* ivf_index);

private:
    IvfRpqIndex merged_index_;
