...
class IvfRpqIndex : public Index
{
public:
    typedef std::shared_ptr<IvfRpqIndex> Pointer;
    IvfRpqIndex();
...
public:
    ...
    const ArrayProfile &GetCentRefineProfile() const
    {
        return cent_refine_profile_;
    }

    ArrayProfile &GetCentRefineProfile()
    {
        return cent_refine_profile_;
    }
...
private:
    ...
    {
        return sizeof(uint8_t) * GetFragmentNum();
    }
...
private:
    ...
    //-----------------support rpq------------------------//
    ArrayProfile cent_refine_profile_;
    std::vector<char> cent_refine_base_;
    //-------------------------------------------------//
