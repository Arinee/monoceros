#ifndef __MERCURY_CORE_GROUP_IVF_PQ_INDEX_H__
#define __MERCURY_CORE_GROUP_IVF_PQ_INDEX_H__
...
class GroupIvfPqIndex : public Index
{
public:
    typedef std::shared_ptr<GroupIvfPqIndex> Pointer;
    GroupIvfPqIndex();
...
#endif //__MERCURY_CORE_GROUP_IVF_PQ_INDEX_H__
