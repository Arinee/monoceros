#ifndef __MERCURY_CORE_GROUP_IVF_PQ_SEARCHER_H__
#define __MERCURY_CORE_GROUP_IVF_PQ_SEARCHER_H__
...
class GroupIvfPqSearcher : public Searcher
{
public:
    typedef std::shared_ptr<GroupIvfPqSearcher> Pointer;
public:
    GroupIvfPqSearcher();
    //! Init from params
...
private:
    ...
    int CalcNodeDist(std::vector<CoarseIndex<BigBlock>::PostingIterator>& ivf_postings,
...
#endif // __MERCURY_CORE_GROUP_IVF_PQ_SEARCHER_H__
