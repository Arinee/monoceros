...
#ifndef __MERCURY_INDEX_INDEX_PQFLAT_H__
#define __MERCURY_INDEX_INDEX_PQFLAT_H__
...
class IndexPqflat : public IndexIvf
{
public:
    typedef std::shared_ptr<IndexPqflat> Pointer;
    ///function interface
    IndexPqflat (){
    ...
    virtual bool Create(IndexStorage::Pointer storage, const std::string& file_name, IndexStorage::Handler::Pointer &&meta_file_handle) override;
    ...
    GENERATE_RETURN_EMPTY_INDEX(IndexPqflat);
    // docid -> code
...
#endif // __MERCURY_INDEX_INDEX_PQFLAT_H__
