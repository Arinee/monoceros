...
struct InstanceFactory
{
    ...
    static IndexMerger::Pointer CreateMerger(const std::string &name);
...
#define INSTANCE_FACTORY_REGISTER_LOGGER(__IMPL__)                                \
    MERCURY_FACTORY_REGISTER(#__IMPL__, mercury::IndexLogger, __IMPL__)

//! Register Index Holder
#define INSTANCE_FACTORY_REGISTER_HOLDER(__IMPL__)                                \
    MERCURY_FACTORY_REGISTER(#__IMPL__, mercury::VectorHolder, __IMPL__)

//! Register Index Builder
#define INSTANCE_FACTORY_REGISTER_BUILDER(__IMPL__)                               \
    MERCURY_FACTORY_REGISTER(#__IMPL__, mercury::IndexBuilder, __IMPL__)

//! Register Vector Service
#define INSTANCE_FACTORY_REGISTER_SEARCHER(__IMPL__)                              \
    MERCURY_FACTORY_REGISTER(#__IMPL__, mercury::VectorService, __IMPL__)

//! Register Index Reducer
#define INSTANCE_FACTORY_REGISTER_REDUCER(__IMPL__)                               \
    MERCURY_FACTORY_REGISTER(#__IMPL__, mercury::IndexReducer, __IMPL__)

//! Register Index Storage
#define INSTANCE_FACTORY_REGISTER_STORAGE(__IMPL__)                               \
    MERCURY_FACTORY_REGISTER(#__IMPL__, mercury::IndexStorage, __IMPL__)

//! Register Index Cluster
#define INSTANCE_FACTORY_REGISTER_CLUSTER(__IMPL__)                               \
    MERCURY_FACTORY_REGISTER(#__IMPL__, mercury::IndexCluster, __IMPL__)

//! Register Index Reformer
#define INSTANCE_FACTORY_REGISTER_REFORMER(__IMPL__)                              \
    MERCURY_FACTORY_REGISTER(#__IMPL__, mercury::IndexReformer, __IMPL__)
