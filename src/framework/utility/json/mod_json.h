...
#ifndef __MERCURY_UTILITY_JSON_MOD_JSON_H__
#define __MERCURY_UTILITY_JSON_MOD_JSON_H__
 ...
 *  \return          1 indicates TRUE, 0 indicates FALSE
 */
static inline mod_json_boolean_t mod_json_value_is_leaked(mod_json_value_t *val)
{
    return (val->refer <= 0);
}
 ...
 *  \return          1 indicates TRUE, 0 indicates FALSE
 */
static inline mod_json_boolean_t mod_json_value_is_shared(mod_json_value_t *val)
{
    return (val->refer > 1);
}
 ...
 *  \return          1 indicates TRUE, 0 indicates FALSE
 */
static inline mod_json_boolean_t mod_json_value_is_array(mod_json_value_t *val)
{
 ...
 *  \return          1 indicates TRUE, 0 indicates FALSE
 */
static inline mod_json_boolean_t mod_json_value_is_object(mod_json_value_t *val)
{
 ...
 *  \return          1 indicates TRUE, 0 indicates FALSE
 */
static inline mod_json_boolean_t mod_json_value_is_string(mod_json_value_t *val)
{
 ...
 *  \return          1 indicates TRUE, 0 indicates FALSE
 */
static inline mod_json_boolean_t mod_json_value_is_float(mod_json_value_t *val)
{
...
mod_json_value_is_boolean(mod_json_value_t *val)
{
 ...
 */
static inline mod_json_boolean_t
mod_json_value_is_integer(mod_json_value_t *val)
{
 ...
 */
static inline mod_json_boolean_t
mod_json_string_is_leaked(mod_json_string_t *str)
{
    return (str->refer <= 0);
}
 ...
 */
static inline mod_json_boolean_t
mod_json_string_is_shared(mod_json_string_t *str)
{
    return (str->refer > 1);
}
 ...
 *  \return          1 indicates TRUE, 0 indicates FALSE
 */
static inline mod_json_boolean_t mod_json_array_is_leaked(mod_json_array_t *arr)
{
    return (arr->refer <= 0);
}
 ...
 *  \return          1 indicates TRUE, 0 indicates FALSE
 */
static inline mod_json_boolean_t mod_json_array_is_shared(mod_json_array_t *arr)
{
    return (arr->refer > 1);
}
 ...
 */
static inline mod_json_boolean_t
mod_json_object_is_leaked(mod_json_object_t *obj)
{
    return (obj->refer <= 0);
}
 ...
 */
static inline mod_json_boolean_t
mod_json_object_is_shared(mod_json_object_t *obj)
{
    return (obj->refer > 1);
}
...
{
    return (obj ? obj->last - obj->first : 0);
}
...
#endif /*__MERCURY_UTILITY_JSON_MOD_JSON_H__*/
